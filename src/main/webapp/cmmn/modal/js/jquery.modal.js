function modal(e) {
	...
	e.cModal = function(t) {
		var n = {
				...
				template: '<div class="modal-box"><div class="modal-inner"><div class="modal-title"></div><div id="ntfFrm"></div><div class="modal-text"></div><div class="modal-buttons"></div></div></div>',
				_classes: {
					box: ".modal-box",
			...
			u = {
				...
				_modalConent: function() {
					...
					if (t.buttons || t.buttons != null) {
						...
						switch (t.type) {
							case "alert":
								c = '<a href="#none" title="OK" id="modalschk" class="modal-btn' + (t.buttons[0].addClass ? " " + t.buttons[0].addClass : "") + '">' + a.ok + "</a>";
								break;
							case "confirm":
								c = '<a href="#none" title="Cancel" class="modal-btn' + (t.buttons[0].addClass ? " " + t.buttons[0].addClass : "") + '">' + a.cancel + '</a><a href="#none" class="modal-btn ' + (t.buttons[1] && t.buttons[1].addClass ? " " + t.buttons[1].addClass : "btn-light-blue") + '">' + a.yes + "</a>";
								break;
							case "prompt":
								c = '<a href="#none" title="Cancel" class="modal-btn' + (t.buttons[0].addClass ? " " + t.buttons[0].addClass : "") + '">' + a.cancel + '</a><a href="#none" class="modal-btn ' + (t.buttons[1] && t.buttons[1].addClass ? " " + t.buttons[1].addClass : "btn-light-blue") + '">' + a.ok + "</a>";
								break;
							default:
								if (t.buttons.length > 0 && e.isArray(t.buttons)) {
									...
									c += '<a href="#none" class="modal-btn">' + a.ok + "</a>"
								}
						}
						e(o).html(c)
					} else {
